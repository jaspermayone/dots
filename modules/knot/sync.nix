...
# Automatically mirrors repositories from your knot server to GitHub
{
  config,
  lib,
  pkgs,
...
let
  cfg = config.jsp.services.knot-sync;
in
{
  options.jsp.services.knot-sync = {
    enable = lib.mkEnableOption "Knot to GitHub sync service";

    repoDir = lib.mkOption {
      type = lib.types.str;
      default = "/var/lib/knot/repos/did:plc:krxbvxvis5skq7jj6eot23ul";
    ...
    logFile = lib.mkOption {
      type = lib.types.str;
      default = "/var/lib/knot/knot-sync.log";
